...
module.exports = class Stat {
    ...
    setSessionsPerBrowser(browserId, value) {
        this._getBrowserStat(browserId).spb = value;
    }

    setSuitesPerSession(browserId, value) {
        this._getBrowserStat(browserId).sps = value;
    }
